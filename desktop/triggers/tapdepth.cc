        ...
        for (int x_col = m_flood_width.m_lower_bound; x_col <= m_flood_width.m_upper_bound; x_col ++) {
            ...
            for (int j = -1;j < 2; j ++) {
                ...
                for (int i = -1;i < 2; i ++) {
                    ...
                    // cv::circle(
                    //     (*params.depth_mat),
                    //     cv::Point(cursor_y+j, cursor_x+i),
                    //     10,
                    ...
                    for (int ch = 0; ch < 3; ch ++) {
                        ...
                        if (diff < floodfill_pixel_variance) {
                            inRangeCnt ++;
                        }
                    }
                }
...
void TriggerTapDepth::flood_fill(Parameters & params, int & cnt) {
    ...
    for (int i = 0; i < 3; i ++) {
        ...
        ch[i] = Range(mid_pixel-floodfill_pixel_variance,
                    mid_pixel+floodfill_pixel_variance);
    }
